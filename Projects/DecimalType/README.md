...
The Decimal value type is used to represent decimal numbers within a specified range. This range includes positive values from 79,228,162,514,264,337,593,543,950,335 to negative values of the same magnitude. By default, the value of a Decimal is 0. This data type is particularly suitable for financial calculations that involve a substantial number of significant digits, both integral and fractional, without any round-off errors. Although the Decimal type does not entirely eradicate the need for rounding, it helps to reduce errors caused by rounding.
